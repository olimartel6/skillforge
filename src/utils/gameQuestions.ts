...
const LESSON_QUESTIONS: Record<string, Record<string, GameQuestion[]>> = {
  'Magic Tricks': {
    ...
    'Palming': [
      { type: 'multiple_choice', prompt: 'What is palming?', options: ['Clapping your hands', 'Secretly hiding an object in your hand', 'Showing both hands empty', 'A type of card cut'], correctAnswer: 'Secretly hiding an object in your hand', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1503095396549-807759245b35?w=440&h=300&fit=crop' },
      { type: 'multiple_choice', prompt: 'Which palm hides a card in the center of your palm?', options: ['Classic palm', 'Finger palm', 'Gambler\'s cop', 'Tenkai palm'], correctAnswer: 'Classic palm', difficulty: 'medium', image: 'https://images.unsplash.com/photo-1503095396549-807759245b35?w=440&h=300&fit=crop' },
    ...
    'Forces': [
      { type: 'multiple_choice', prompt: 'What is a "force" in magic?', options: ['Making someone pick a specific card while they feel free', 'Pushing someone to volunteer', 'Bending a card with force', 'Using physical strength in tricks'], correctAnswer: 'Making someone pick a specific card while they feel free', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1529480780361-ba1eb4a44de8?w=440&h=300&fit=crop' },
      { type: 'multiple_choice', prompt: 'What is the "Hindu Shuffle Force"?', options: ['A force using a Hindu prayer', 'Running packets off the deck, stopping when told', 'A force invented in India', 'Spreading cards on a Hindu rug'], correctAnswer: 'Running packets off the deck, stopping when told', difficulty: 'medium', image: 'https://images.unsplash.com/photo-1529480780361-ba1eb4a44de8?w=440&h=300&fit=crop' },
  ...
  'Trading': {
    'Market Basics': [
      { type: 'multiple_choice', prompt: 'What is a stock?', options: ['A type of bond', 'Ownership share in a company', 'A government loan', 'A savings account'], correctAnswer: 'Ownership share in a company', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'The stock market is open 24/7.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=440&h=300&fit=crop' },
    ...
    'Bull vs Bear': [
      { type: 'multiple_choice', prompt: 'What is a bull market?', options: ['Prices are falling', 'Prices are rising', 'Market is closed', 'Market is flat'], correctAnswer: 'Prices are rising', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1621504450181-5d356f61d307?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'A bear market means prices are going up.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1621504450181-5d356f61d307?w=440&h=300&fit=crop' },
    ...
    'Chart Reading': [
      { type: 'multiple_choice', prompt: 'What does the X-axis usually show on a stock chart?', options: ['Price', 'Volume', 'Time', 'Profit'], correctAnswer: 'Time', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1642790106117-e829e14a795f?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'A line chart connects closing prices over time.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1642790106117-e829e14a795f?w=440&h=300&fit=crop' },
    ...
    'Candlesticks': [
      { type: 'multiple_choice', prompt: 'What does a green/white candle mean?', options: ['Price went down', 'Price went up', 'Market closed', 'No trades'], correctAnswer: 'Price went up', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1642790106117-e829e14a795f?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'A red/black candle means the price closed lower than it opened.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1642790106117-e829e14a795f?w=440&h=300&fit=crop' },
    ...
    'Support & Resist.': [
      { type: 'multiple_choice', prompt: 'What is a support level?', options: ['Where price tends to stop falling', 'Where price always rises', 'The highest price ever', 'A government price floor'], correctAnswer: 'Where price tends to stop falling', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1535320903710-d993d3d77d29?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Resistance is a price level where selling pressure tends to emerge.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1535320903710-d993d3d77d29?w=440&h=300&fit=crop' },
    ...
    'Volume Analysis': [
      { type: 'multiple_choice', prompt: 'What does volume measure?', options: ['Price change', 'Number of shares traded', 'Company profit', 'Market hours'], correctAnswer: 'Number of shares traded', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'High volume confirms a price move\'s strength.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?w=440&h=300&fit=crop' },
    ...
    'Moving Averages': [
      { type: 'multiple_choice', prompt: 'What is a moving average?', options: ['The highest price', 'Average price over a set period', 'Tomorrow\'s predicted price', 'The opening price'], correctAnswer: 'Average price over a set period', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'The 200-day moving average is commonly used for long-term trends.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=440&h=300&fit=crop' },
    ...
    'Risk Management': [
      { type: 'multiple_choice', prompt: 'What is a stop-loss order?', options: ['An order to buy more', 'An order that sells when price hits a set low', 'A limit on trading hours', 'A broker fee'], correctAnswer: 'An order that sells when price hits a set low', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'You should risk no more than 1-2% of your account on one trade.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=440&h=300&fit=crop' },
  ...
  'Business': {
    'Entrepreneur Mind': [
      { type: 'multiple_choice', prompt: 'What defines an entrepreneur?', options: ['Someone with a job', 'Someone who starts and runs a business', 'A manager at a corporation', 'A freelancer only'], correctAnswer: 'Someone who starts and runs a business', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Failure is a normal part of entrepreneurship.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=440&h=300&fit=crop' },
    ...
    'Finding Ideas': [
      { type: 'multiple_choice', prompt: 'Where do the best business ideas come from?', options: ['Copying competitors exactly', 'Solving real problems people have', 'Random brainstorming only', 'Buying ideas online'], correctAnswer: 'Solving real problems people have', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1493612276216-ee3925520721?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'A good business idea must be completely original.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1493612276216-ee3925520721?w=440&h=300&fit=crop' },
  ...
  'Cooking': {
    'Kitchen Setup': [
      { type: 'multiple_choice', prompt: 'What is "mise en place"?', options: ['A French dessert', 'Everything in its place — prepping before cooking', 'A type of oven', 'A cooking technique'], correctAnswer: 'Everything in its place — prepping before cooking', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'You should read the full recipe before starting to cook.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=440&h=300&fit=crop' },
    ...
    'Knife Skills': [
      { type: 'multiple_choice', prompt: 'What is the "claw grip" used for?', options: ['Opening jars', 'Holding food safely while cutting', 'Sharpening knives', 'Stirring soup'], correctAnswer: 'Holding food safely while cutting', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1574926054530-540288c8e678?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'A dull knife is safer than a sharp knife.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1574926054530-540288c8e678?w=440&h=300&fit=crop' },
    ...
    'Heat Control': [
      { type: 'multiple_choice', prompt: 'What does "medium heat" generally mean?', options: ['Maximum flame', 'About halfway on the dial', 'The lowest setting', 'Off'], correctAnswer: 'About halfway on the dial', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Higher heat always means faster, better cooking.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=440&h=300&fit=crop' },
    ...
    'Basic Cuts': [
      { type: 'multiple_choice', prompt: 'What is a "julienne" cut?', options: ['Large cubes', 'Thin matchstick strips', 'Rough chop', 'Paper-thin slices'], correctAnswer: 'Thin matchstick strips', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1590779033100-9f60a05a013d?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'A "dice" means cutting food into small cubes.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1590779033100-9f60a05a013d?w=440&h=300&fit=crop' },
    ...
    'Seasoning': [
      { type: 'multiple_choice', prompt: 'When should you season during cooking?', options: ['Only at the end', 'Only at the start', 'In layers throughout cooking', 'Never'], correctAnswer: 'In layers throughout cooking', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1532336414038-cf19250c5757?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Kosher salt and table salt measure the same by volume.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'medium', image: 'https://images.unsplash.com/photo-1532336414038-cf19250c5757?w=440&h=300&fit=crop' },
    ...
    'Sautéing': [
      { type: 'multiple_choice', prompt: 'What does "sauté" mean in French?', options: ['To bake', 'To jump', 'To boil', 'To freeze'], correctAnswer: 'To jump', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1551218808-94e220e084d2?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Sautéing uses high heat and a small amount of fat.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1551218808-94e220e084d2?w=440&h=300&fit=crop' },
    ...
    'Boiling & Steam': [
      { type: 'multiple_choice', prompt: 'At what temp does water boil at sea level?', options: ['100°C / 212°F', '90°C / 194°F', '80°C / 176°F', '120°C / 248°F'], correctAnswer: '100°C / 212°F', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'A "simmer" has smaller, gentler bubbles than a full boil.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?w=440&h=300&fit=crop' },
    ...
    'Roasting': [
      { type: 'multiple_choice', prompt: 'What temperature range is typical for roasting?', options: ['100-150°C', '200-230°C / 400-450°F', '50-80°C', '300-350°C'], correctAnswer: '200-230°C / 400-450°F', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Roasting uses dry heat in an oven.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=440&h=300&fit=crop' },
  ...
  'Fitness': {
    'Body Basics': [
      { type: 'multiple_choice', prompt: 'How many major muscle groups does the body have?', options: ['3', '6', '11', '20'], correctAnswer: '11', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Muscles grow during rest, not during exercise.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=440&h=300&fit=crop' },
    ...
    'Warm-Up': [
      { type: 'multiple_choice', prompt: 'Why is warming up important?', options: ['To waste time', 'To increase blood flow and prevent injury', 'To show off', 'It\'s not important'], correctAnswer: 'To increase blood flow and prevent injury', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Static stretching is the best warm-up before exercise.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=440&h=300&fit=crop' },
    ...
    'Push-Ups': [
      { type: 'multiple_choice', prompt: 'Which muscles do push-ups primarily work?', options: ['Legs and glutes', 'Chest, shoulders, and triceps', 'Back and biceps', 'Only abs'], correctAnswer: 'Chest, shoulders, and triceps', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1598971639058-fab3c3109a00?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Your body should form a straight line during a push-up.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1598971639058-fab3c3109a00?w=440&h=300&fit=crop' },
    ...
    'Squats': [
      { type: 'multiple_choice', prompt: 'Which muscles do squats primarily target?', options: ['Arms and shoulders', 'Quads, glutes, and hamstrings', 'Chest and back', 'Only calves'], correctAnswer: 'Quads, glutes, and hamstrings', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1574680096145-d05b474e2155?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Your knees should cave inward during squats.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1574680096145-d05b474e2155?w=440&h=300&fit=crop' },
  ...
  'Chess': {
    'The Board': [
      { type: 'multiple_choice', prompt: 'How many squares are on a chess board?', options: ['32', '48', '64', '100'], correctAnswer: '64', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1529699211952-734e80c4d42b?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'The board has an equal number of light and dark squares.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1529699211952-734e80c4d42b?w=440&h=300&fit=crop' },
    ...
    'Piece Moves': [
      { type: 'multiple_choice', prompt: 'How does a knight move?', options: ['Diagonally only', 'In an L-shape', 'Straight lines only', 'One square any direction'], correctAnswer: 'In an L-shape', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1560174038-da43ac74f01b?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'A bishop can only move diagonally.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1560174038-da43ac74f01b?w=440&h=300&fit=crop' },
    ...
    'Check & Mate': [
      { type: 'multiple_choice', prompt: 'What is "check"?', options: ['Winning the game', 'The king is under attack', 'Capturing a piece', 'A draw'], correctAnswer: 'The king is under attack', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1528819622765-d6bcf132f793?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Checkmate ends the game immediately.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1528819622765-d6bcf132f793?w=440&h=300&fit=crop' },
  ...
  'Coding': {
    'What is Code?': [
      { type: 'multiple_choice', prompt: 'What is computer code?', options: ['A secret language', 'Instructions that tell a computer what to do', 'Random numbers', 'A type of hardware'], correctAnswer: 'Instructions that tell a computer what to do', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Computers understand human language directly.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=440&h=300&fit=crop' },
    ...
    'Variables': [
      { type: 'multiple_choice', prompt: 'What is a variable?', options: ['A fixed number', 'A named container that stores data', 'A type of loop', 'A programming language'], correctAnswer: 'A named container that stores data', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Variable names can start with a number.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=440&h=300&fit=crop' },
  ...
  'Drawing': {
    'Line Basics': [
      { type: 'multiple_choice', prompt: 'What is the most fundamental element of drawing?', options: ['Color', 'The line', 'Texture', 'Shading'], correctAnswer: 'The line', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Drawing from the shoulder gives smoother, longer lines.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=440&h=300&fit=crop' },
    ...
    'Shapes & Forms': [
      { type: 'multiple_choice', prompt: 'What are the basic shapes in drawing?', options: ['Only circles', 'Circle, square, triangle', 'Hexagon and octagon only', 'Only rectangles'], correctAnswer: 'Circle, square, triangle', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Complex objects can be broken down into basic shapes.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=440&h=300&fit=crop' },
    ...
    'Light & Shadow': [
      { type: 'multiple_choice', prompt: 'What is the darkest area on a lit object called?', options: ['Highlight', 'Core shadow', 'Reflected light', 'Cast shadow'], correctAnswer: 'Core shadow', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Light source direction determines where shadows fall.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=440&h=300&fit=crop' },
    ...
    'Proportions': [
      { type: 'multiple_choice', prompt: 'How many "heads tall" is an average adult figure?', options: ['5', '6', '7.5-8', '10'], correctAnswer: '7.5-8', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1580136579312-94651dfd596d?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Eyes are roughly at the halfway point of the head.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1580136579312-94651dfd596d?w=440&h=300&fit=crop' },
  ...
  'Guitar': {
    'Holding Guitar': [
      { type: 'multiple_choice', prompt: 'How should you sit when holding a guitar?', options: ['Slouched back', 'Upright with guitar on your leg', 'Lying down', 'Standing on one foot'], correctAnswer: 'Upright with guitar on your leg', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1510915361894-db8b60106cb1?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'The neck of the guitar should point downward.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1510915361894-db8b60106cb1?w=440&h=300&fit=crop' },
    ...
    'Open Chords': [
      { type: 'multiple_choice', prompt: 'What is an open chord?', options: ['A broken chord', 'A chord using open (unfretted) strings', 'A chord played at the 12th fret', 'A chord with no sound'], correctAnswer: 'A chord using open (unfretted) strings', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1525201548942-d8732f6617a0?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'G, C, D, E, and A are common beginner open chords.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1525201548942-d8732f6617a0?w=440&h=300&fit=crop' },
    ...
    'Strumming': [
      { type: 'multiple_choice', prompt: 'What should drive the strumming motion?', options: ['Fingers', 'Wrist', 'Shoulder', 'Elbow'], correctAnswer: 'Wrist', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Strumming patterns combine downstrokes and upstrokes.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=440&h=300&fit=crop' },
    ...
    'Finger Exercises': [
      { type: 'multiple_choice', prompt: 'What does the "spider walk" exercise train?', options: ['Speed only', 'Finger independence and dexterity', 'Singing', 'Ear training'], correctAnswer: 'Finger independence and dexterity', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1564186763535-ebb21ef5277f?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Finger exercises should be practiced slowly first, then speed up.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1564186763535-ebb21ef5277f?w=440&h=300&fit=crop' },
  ...
  'Piano': {
    'Keyboard Layout': [
      { type: 'multiple_choice', prompt: 'How many white keys are in one octave?', options: ['5', '7', '8', '12'], correctAnswer: '7', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'A full-size piano has 88 keys.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?w=440&h=300&fit=crop' },
    ...
    'Basic Scales': [
      { type: 'multiple_choice', prompt: 'How many notes are in a major scale?', options: ['5', '6', '7', '8'], correctAnswer: '7', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1552422535-c45813c61732?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'The C major scale uses only white keys.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1552422535-c45813c61732?w=440&h=300&fit=crop' },
  ...
  'Photography': {
    'Camera Basics': [
      { type: 'multiple_choice', prompt: 'What does a camera sensor do?', options: ['Stores photos', 'Captures light and converts it to an image', 'Zooms in', 'Adds filters'], correctAnswer: 'Captures light and converts it to an image', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Megapixels alone determine photo quality.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=440&h=300&fit=crop' },
    ...
    'Composition': [
      { type: 'multiple_choice', prompt: 'What is composition in photography?', options: ['The camera brand', 'How elements are arranged in the frame', 'Editing software', 'The file format'], correctAnswer: 'How elements are arranged in the frame', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Centering the subject always makes the best composition.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=440&h=300&fit=crop' },
    ...
    'Rule of Thirds': [
      { type: 'multiple_choice', prompt: 'What is the rule of thirds?', options: ['Only take 3 photos', 'Divide the frame into a 3x3 grid and place subjects on lines', 'Use 3 colors', 'Shoot in groups of 3'], correctAnswer: 'Divide the frame into a 3x3 grid and place subjects on lines', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'The most interesting spots are where grid lines intersect.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=440&h=300&fit=crop' },
    ...
    'Natural Light': [
      { type: 'multiple_choice', prompt: 'What is "golden hour"?', options: ['Midnight', 'Shortly after sunrise or before sunset', 'Noon', 'Any cloudy day'], correctAnswer: 'Shortly after sunrise or before sunset', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1495616811223-4d98c6e9c869?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Harsh midday sun creates the most flattering portraits.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1495616811223-4d98c6e9c869?w=440&h=300&fit=crop' },
    ...
    'Focus': [
      { type: 'multiple_choice', prompt: 'What is "depth of field"?', options: ['How deep the ocean is in a photo', 'How much of the image is in sharp focus', 'The depth of the camera', 'A filter effect'], correctAnswer: 'How much of the image is in sharp focus', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'Autofocus is always more accurate than manual focus.', options: ['True', 'False'], correctAnswer: 'False', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=440&h=300&fit=crop' },
    ...
    'Exposure': [
      { type: 'multiple_choice', prompt: 'What three things control exposure?', options: ['RGB colors', 'Aperture, shutter speed, ISO', 'Focus, zoom, flash', 'Contrast, brightness, saturation'], correctAnswer: 'Aperture, shutter speed, ISO', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1493863641943-9b68992a8d07?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'The exposure triangle balances aperture, shutter speed, and ISO.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1493863641943-9b68992a8d07?w=440&h=300&fit=crop' },
    ...
    'Aperture': [
      { type: 'multiple_choice', prompt: 'What does aperture control?', options: ['Zoom', 'The size of the lens opening', 'Focus point', 'Flash power'], correctAnswer: 'The size of the lens opening', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1542038784456-1ea8df1e6b1c?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'A smaller f-number means a wider aperture opening.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1542038784456-1ea8df1e6b1c?w=440&h=300&fit=crop' },
    ...
    'Shutter Speed': [
      { type: 'multiple_choice', prompt: 'What does shutter speed control?', options: ['Aperture size', 'How long the sensor is exposed to light', 'ISO level', 'Focus accuracy'], correctAnswer: 'How long the sensor is exposed to light', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1530281700549-e82e7bf110d6?w=440&h=300&fit=crop' },
      { type: 'true_false', prompt: 'A fast shutter speed freezes motion.', options: ['True', 'False'], correctAnswer: 'True', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1530281700549-e82e7bf110d6?w=440&h=300&fit=crop' },
  ...
  'Dance': {
    ...
    'Basic Steps': [
      { type: 'multiple_choice', prompt: 'What is a "step-touch"?', options: ['A tap dance move', 'Step to the side, then bring the other foot to touch', 'A jump', 'A spin'], correctAnswer: 'Step to the side, then bring the other foot to touch', difficulty: 'easy', image: 'https://images.unsplash.com/photo-1535525153412-5a42439a210d?w=440&h=300&fit=crop' },
